...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-0'> 
      ...
      <h3 className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>Hi! I'm Abhishek Bhujbal <Image src={assets.hand_icon} alt='' className='w-6'/></h3>

    <h1 className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'> Full Stack Developer based in India.</h1>

    <p className='max-w-2xl mx-auto font-Ovo'>I am a  Full Stack Developer from Pune,India with a experience on multiple project like Daily-Workers-Finder(RozzgarSetu), Farming-Equipments-Rental, TextUtils, NewsApp(SPA) etc..</p>
